...
module.exports = function (elric) {
	...
	bp.postConstructor = function postConstructor () {
		 ...
		 * @version  2013.02.21
		 */
		base.prototype.setOrigin = function setOrigin (new_origin) {
			
			if (new_origin.element_id) {
				this.origin.element = this.elric.models.roomElement.cache[new_origin.element_id];
			}
			
			if (new_origin.room_id) {
				this.origin.room = this.elric.models.room.cache[new_origin.room_id];
			}
		}
		
		base.prototype.on_start = function(){};
		base.prototype.on_end = function(){};
		
		/**
		 * The activity instance constructor
		 * 
		 * @author   Jelle De Loecker   <jelle@kipdola.be>
		 * @since    2013.02.21
		 * @version  2013.02.21
